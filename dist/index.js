...
(() => {
  ...
  var simulateEvent = (target, events2) => {
    if (!Array.isArray(events2))
      events2 = [events2];
    const eventsSuccess = events2.map((event) => target.dispatchEvent(new Event(event, { bubbles: true })));
  ...
  // src/interactions/swiper.ts
  var SwiperSlideshow = class {
    LIST_WRAPPER_ATTRIBUTE = "slideshow-list-wrapper";
    LIST_ATTRIBUTE = "slideshow-list";
    LIST_ITEM_ATTRIBUTE = "slideshow-item";
    BUTTON_NEXT_ATTRIBUTE = "slideshow-button-next";
    BUTTON_PREV_ATTRIBUTE = "slideshow-button-prev";
    _listWrapper;
    _list;
    _listItems;
    _gap;
